		...
		jQuery.ajax({
            ...
            success: function(data) {
                ...
                if (fel == "true") {
					...
					$(location).attr('href','resultsrapid.php')
				}
                }
            }
        });   
	...
	jQuery.ajax({
            ...
            success: function(data) {
                ...
                if (fel == "true") {
					...
					if (isdone == '1') {
					$("#resu").append('<span class="appt-block bookedClearFix approved"><span class="status-block"><i class="booked-icon booked-icon-radio-checked"></i> <?=gettext("Played");?></span><i class="booked-icon booked-icon-clock"></i><strong>'+result+' <?=gettext("secounds");?></strong> <?=gettext("on");?> <?php echo $rounds; ?> <?=gettext("hits.");?></span> ');
